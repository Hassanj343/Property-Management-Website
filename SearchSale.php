...
$controller->setpageattr("name","investorproperty");
...
if(empty($properties)){
	$properties=$dbconnection->fetchall_byval('properties','type','sale');
}
...
?>
	<section class='MainArea'>
		<div class="container">
			<div class="row">
				<div class="search">
					<form method="post" action="SearchSale.php" class="row">
						<div class="col-sm-8" >
